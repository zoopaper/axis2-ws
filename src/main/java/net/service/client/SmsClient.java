...
public class SmsClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            resultFeedbackEvt.setMSISDN("18810489320");
            resultFeedbackEvt.setRescode("900000");
            resultFeedbackEvt.setResdesc("msg desc");
            resultFeedbackEvt.setRevdate("20150813175812");
//            resultFeedbackEvt.setMsg(new String("暗香@526@1200@908@order@222".getBytes(), "UTF-8"));
            resultFeedbackEvt.setMsg(new String("明科@111@1200@908@mm@222".getBytes(), "UTF-8"));
